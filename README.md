[![The word 'fediverse' translated into multiple languages, written in shades of gray on a dark background.](public/images/fediverse.png)](https://github.com/jointhefediverse-net/jointhefediverse.net/tree/main/public/images/fediverse.png)
